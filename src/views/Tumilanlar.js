...
const Tumilanlar = ({ navigation, route }) => {
    ...
    return (
        ...
        <View style={{ flex: 1, backgroundColor: "white" }}>
            ...
            {ilanListe.length > 0 ? <FlatList ListFooterComponent={loadMore} extraData={true} onEndReached={dataekle} data={ilanListe} renderItem={(item, index) => ilanlariListele(item, index)} /> : ""}
                    ...
                    <View style={styles.modalContent}>
                        ...
                        <View style={styles.center}>
                            ...
                            <ScrollView>
                                ...
                                <TouchableOpacity onPress={() => { setFilter(false), navigation.navigate('FilterCekis') }}>
                                    <View style={{ width: "100%", height: 75, flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
                                        <View style={{ width: "90%", flexDirection: "column" }}><Text style={{ fontSize: 17 }}>Çekiş</Text>
                                ...
                                <Button
                                        ...
                                        onPress={async () => {
                                           ...
                                           if(MarkaFiltreleri.length==0)
                                           {
                                               await firestore().collection("ilanlar").get().then(result => {
                                                result.forEach(element => {
                                               ...
                                               koleksiyon.push({MarkaFiltreleri:markalar});
                                           }         
                                           else 
                                           {
                                             filtercheck++;
                                             koleksiyon.push({MarkaFiltreleri:MarkaFiltreleri})
                                           } 
                                           if(YakitFiltre.length==0)
                                           {
                                               
                                               koleksiyon.push({YakitFiltre:['Benzin','Dizel','Elektrik']})
                                           }
                                           else 
                                           {
                                             filtercheck++;
                                             koleksiyon.push({YakitFiltre:YakitFiltre})
                                           }
                                           if(CekisFiltre.length==0)
                                           {
                                              koleksiyon.push({CekisFiltre:['Önden Çekiş','Arkadan İtiş']})
                                           }
                                           else
                                           {
                                              filtercheck++;
                                              koleksiyon.push({CekisFiltre:CekisFiltre});
                                           }      
                                           if(filtercheck==0)
                                           {
                                            setFilter(false);
                                           ...
                                           {
                                            setFilter(false);
                                            navigation.navigate('Filterilan',{FiltreDizisi:koleksiyon});
                                           }                  
